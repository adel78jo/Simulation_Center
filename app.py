...
# تم تثبيت هذه القيم، ويجب تغييرها هنا فقط.
# ==========================================
...
# ==========================================
    ...
    if st.session_state['logged_in']:
        ...
        # ---------------------------------------------
        # نموذج تسجيل الدخول (النسخة الآمنة)
        # ---------------------------------------------
        st.subheader("الرجاء تسجيل الدخول للوصول إلى لوحة الإدارة.")
        
        login_col1, login_col2 = st.columns([1, 1]) # تقسيم متساوٍ
        ...
        with login_col2:
            st.info("""
            **🔐 وصول الإدارة:**
            الرجاء استخدام اسم المستخدم وكلمة المرور المحددة مسبقاً.
            (تم إزالة بيانات الاعتماد من الواجهة العامة لضمان الأمان).
            """)
