...
if st.session_state['logged_in']:
    ...
    # 🚀 القائمة الجانبية مع أيقونات Font Awesome الفاخرة 🚀
    menu = st.sidebar.radio(
        ...
        icons=[
            "cpu",           # لوحة التحكم - معالج (تقنية)
            "book",          # إدارة الدورات - كتاب
            "chalkboard-user", # إدارة المدربين - سبورة ومدرب
            "chart-line",    # التقارير - رسم بياني
            "search-check",  # التدقيق - بحث وفحص
            "key-fill"       # الأدوات المتقدمة - مفتاح
        ]
    )
