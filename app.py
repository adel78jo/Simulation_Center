...
if st.session_state['logged_in']:
    ...
    if menu == "🏠 لوحة التحكم":
        ...
        if st.session_state['trainees']:
            ...
            with chart_col:
                st.bar_chart(college_counts, color=var(--secondary-color))
    ...
    # ==========================================
    # 2. قسم تسجيل الدورات (تمت إعادة التسمية)
    # ==========================================
        ...
        # تم دمج محتوى هذا القسم مع إدارة النظام الكاملة في الكود السابق،
        # لكن سنعيد هيكلته هنا ليتناسب مع القائمة الجانبية الجديدة (دارة الدورات = إدارة الدورات في التاب)
        ...
        # تعديل دورة (باقي تفاصيل الإدارة في قسم الإدارة الكاملة)
    ...
    # ---------------------------------------------
    # شاشة تسجيل الدخول (إذا لم يتم تسجيل الدخول)
    # ---------------------------------------------
    ...
    with login_col2:
        st.info("""
        **بيانات الوصول الخاصة بك (للتطوير):**
        * اسم المستخدم: `AABU`
        * كلمة المرور: `Aabu2025`
        """)
